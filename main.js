...
function playRound(playerSelection, computerSelection) {
  ...
  if(playerSelection == computerSelection) { 
    return "Draw! " +  capitalizeFirstLetter(playerSelection) + 
           " and " + capitalizeFirstLetter(computerSelection)
  }
          ...
          { 
    playerScore++
    return "You win! " + capitalizeFirstLetter(playerSelection) +
           " beats " + capitalizeFirstLetter(computerSelection) 
  }
  else { 
    compScore++
    return "You lose! " + capitalizeFirstLetter(computerSelection) + 
